...
if __name__ == '__main__':
    ...
    if Cte_value:
        ...
        stim_dict4.update({'th_start': 200.0})
        stim_dict4.update({'th_duration': 500.0})
        stim_dict4.update({'th_rate': 5.0})
    ...
    stim_dict4.update({'thalamic_input': True})
    stim_dict4.update({'th_start': 500.0})
    stim_dict4.update({'th_duration': 400.0})
    stim_dict4.update({'th_rate': 20.0})
